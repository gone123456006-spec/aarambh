...
const privacyCards = [
  ...
  card('4. Camera and microphone', `${APP.appName} requests camera/microphone only when you start video or voice practice. No background access. No photo gallery access.`),
  card('5. Random chat and user content', 'Chat messages are visible to matched partners during a session. Automated filters apply. Skip or report users from chat or Contact Us. For English practice only — not dating.'),
